import {
  ...
  taskListElement,
  TaskListLink,
  taskListElementaskSearchBarButton,
  darkThemeToggleElement,
  getCheckboxElements,
  getDeleteIcons,
  inputElement,
} from "./scripts.js/elements";
import { initListeners, initTaskListeners } from "./scripts.js/eventListeners";
import { initDataOnStartup } from "./scripts.js/utils";
initDataOnStartup();
initListeners();
